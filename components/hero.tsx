...
export default function Hero() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(120deg, #fffbeb 0%, #ffedd5 100%)" }}
    >
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              asChild
            >
              <Link href={APP_LINKS.documentation} target="_blank" rel="noopener noreferrer">
                Read Documentation
                <ExternalLink className="w-4 h-4 ml-2" />
              </Link>
            </Button>
            <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white" asChild>
              <Link href={APP_LINKS.webApp} target="_blank" rel="noopener noreferrer">
                Launch Web App
                <ExternalLink className="w-4 h-4 ml-2" />
              </Link>
            </Button>
            <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white" asChild>
              <Link href={APP_LINKS.farcasterMiniApp} target="_blank" rel="noopener noreferrer">
                Farcaster Mini App
                <ExternalLink className="w-4 h-4 ml-2" />
              </Link>
            </Button>
